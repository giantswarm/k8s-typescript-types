...
export interface AWSManagedControlPlane {
  ...
  spec?: {
     ...
     *
     * Items: AccessEntry represents an AWS EKS access entry for IAM principals
     */
    accessEntries?: {
      /**
       ...
       * @maxItems 20
       *
       * Items: AccessPolicyReference represents a reference to an AWS EKS access policy
       */
      accessPolicies?:
        | []
        | [
    ...
    network?: {
      ...
      additionalControlPlaneIngressRules?: {
        ...
        sourceSecurityGroupRoles?: (
          'bastion' | 'node' | 'controlplane' | 'apiserver-lb' | 'lb' | 'node-eks-additional'
        )[];
        /**
     ...
     */
    upgradePolicy?: 'extended' | 'standard';
    /**
