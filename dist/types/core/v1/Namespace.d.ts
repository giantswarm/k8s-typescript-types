 ...
 */
export type NamespaceConditionType = 'NamespaceDeletionDiscoveryFailure' | 'NamespaceDeletionContentFailure' | 'NamespaceDeletionGVParsingFailure' | 'NamespaceContentRemaining' | 'NamespaceFinalizersRemaining';
/**
